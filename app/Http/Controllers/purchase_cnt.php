...
class purchase_cnt extends Controller
{
    ...
    public function index()
    {
        ...
        return view('purchase.purchase_index',['pur_emp'=>$pur_emp,'task'=>$task,'staffNames'=>$staffNames,'taskCounts'=>$taskCounts,'categoryNames'=>$categoryNames,'categorytaskCounts'=>$categorytaskCounts,'subcategoryNames'=>$subcategoryNames,'subcategorytaskCounts'=>$subcategorytaskCounts,'pendingLeaves'=>$pendingLeaves]);
    }
