    ...
    <div class="sidebodydiv px-5 mb-4">
        <div class="sidebodyback my-3" onclick="goBack()">
            <div class="backhead">
                ...
                <h6 class="m-0">Cluster Details</h6>
            </div>
        </div>
                    ...
                    <div class="basicdetails mb-2">
                        <div class="maincard row">
                            ...
                            <div
                                ...
                                <img src="{{ asset($mc->profile_image ?? 'assets/images/avatar.png') }}" width="125px"
                                    height="125px" alt="" class="profileimg">
                            </div>
                            <div class="row mt-2">
                                <div class="col-sm-12 col-md-12 col-xl-12 mb-3">
                                    <h6 class="mb-1">Cluster Name</h6>
                                    <h5 class="mb-0">{{ $mc->name }}</h5>
                                </div>
                                <div class="col-sm-12 col-md-12 col-xl-12 mb-3">
                                    <h6 class="mb-1">Email ID</h6>
                                    <h5 class="mb-0">{{ $mc->email }}</h5>
                                </div>
                                <div class="col-sm-12 col-md-12 col-xl-12 mb-3">
                                    <h6 class="mb-1">Contact Number</h6>
                                    <h5 class="mb-0">{{ $mc->contact_no }}</h5>
                                </div>
                                <div class="col-sm-12 col-md-12 col-xl-12 mb-3">
                                    <h6 class="mb-1">Alternate Contact Number</h6>
                                    <h5 class="mb-0">{{ $mc->alter }}</h5>
                                </div>
                                <div class="col-sm-12 col-md-12 col-xl-12 mb-3">
                                    <h6 class="mb-1">Address</h6>
                                    <h5 class="mb-0">{{ $mc->address }}</h5>
                                </div>
                                <div class="col-sm-12 col-md-12 col-xl-12 mb-3">
                                    <h6 class="mb-1">Pincode</h6>
                                    <h5 class="mb-0">{{ $mc->pincode }}</h5>
                                </div>
                                <div class="col-sm-12 col-md-12 col-xl-12 mb-3">
                                    <h6 class="mb-1">Cluster Geolocation</h6>
                                    <h5 class="mb-0">{{ $mc->location }}</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade show active" id="store" role="tabpanel" aria-labelledby="store-tab">
                        <div class="empdetails">
                            <div class="sidebodyhead">
                                <h4 class="m-0">Store List Details</h4>
                            </div>
